...
A = quad_chab_ell_im_quad(E, 13, 20, 5, K, int_list = int_points, bernardi = False, up_to_auto = True)
...
extra_points_13 = A[2] + A[3]

print "extra_points_13:"
sys.stdout.flush()
print extra_points_13
sys.stdout.flush()
